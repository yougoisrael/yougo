...
import { C, IcoBack, IcoClose, IcoCheck, IcoShield, IcoBit, IcoApple, IcoPlus } from "../components/Icons";
  ...
  return (
    <div style={{ fontFamily: "Arial,sans-serif", background: C.bg, minHeight: "100vh", maxWidth: 430, margin: "0 auto", direction: "rtl", paddingBottom: 30 }}>
      ...
      <div style={{ padding: "0 16px" }}>
        ...
        {[
          { Ico: IcoBit,   l: "ביט",      s: "מחובר",    c: "#E91E8C" },
          { Ico: IcoCheck, l: "PayBox",    s: "לא מחובר", c: "#22C55E" },
          { Ico: IcoApple, l: "Apple Pay", s: "לא זמין",  c: C.dark },
        ].map((w, i) => (
