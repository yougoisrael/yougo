...
function Sidebar({ open, onClose, user, navigate }) {
  return (
    <>
      <div onClick={onClose} style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.45)", zIndex:600, pointerEvents:"auto", touchAction:"none", opacity:open?1:0, pointerEvents:open?"all":"none", transition:"opacity 0.3s ease" }}/>
      <div style={{ position:"fixed", top:0, right:0, height:"100dvh", width:280, maxWidth:"80vw", background:"white", zIndex:601, display:"flex", flexDirection:"column", transform:open?"translateX(0)":"translateX(100%)", transition:"transform 0.35s cubic-bezier(0.34,1.1,0.64,1)", boxShadow:"-8px 0 40px rgba(0,0,0,0.15)" }}>
        ...
        <div style={{ flex:1, padding:"12px 0", overflowY:"auto", overflowY:"auto" }}>
          {[
