...
export default function OrdersPage({ cartCount, user, guest, onLogin }) {
  ...
  return (
    <div className="page-enter" style={{ fontFamily: "Arial,sans-serif", background: C.bg, minHeight: "100vh", maxWidth: 430, margin: "0 auto", direction: "rtl", paddingBottom: 80 }}>
      ...
      <div style={{ padding: "12px 16px" }}>
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: "50px 0", color: C.gray }}>
            <div style={{ display: "flex", justifyContent: "center", marginBottom: 12 }}><IcoPackage s={44} c={C.lightGray}/></div>
